...
OPENAI_API_MODE = _env("OPENAI_API_MODE", "responses").lower()
OPENAI_REASONING_EFFORT = _env("OPENAI_REASONING_EFFORT", "low").lower()
OPENAI_TEXT_VERBOSITY = _env("OPENAI_TEXT_VERBOSITY", "low").lower()
OPENAI_TEMPERATURE = _env_float("OPENAI_TEMPERATURE", 0.3)
OPENAI_MAX_OUTPUT_TOKENS = _env_int("OPENAI_MAX_OUTPUT_TOKENS", 900)
CHAT_MAX_MESSAGE_CHARS = max(_env_int("CHAT_MAX_MESSAGE_CHARS", 1500), 200)
CORRECTION_MEMORY_MAX = max(_env_int("CORRECTION_MEMORY_MAX", 6), 0)
OPENAI_CORRECTIONS_VECTOR_STORE_ID = _env("OPENAI_CORRECTIONS_VECTOR_STORE_ID")
